...
public class VideoHistoryController {
        ...
        @RequestMapping(method = RequestMethod.POST, value = "/users/video-history")
        public ResponseEntity<CompositePrimaryKey> createNewHistory(@RequestAttribute("userId") String userId,
                        @RequestParam("video_id") int videoId, HttpServletRequest request) {
        ...
        @RequestMapping(method = RequestMethod.GET, value = "/users/video-history")
        ...
        @RequestMapping(method = RequestMethod.DELETE, value = "/users/video-history")
        public ResponseEntity<CompositePrimaryKey> deleteHistory(@RequestAttribute("userId") String userId,
                        @RequestParam("video_id") int videoId, HttpServletRequest request) {
